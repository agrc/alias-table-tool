...
class Main(object):
    ...
    def start(self):
        arcpy.AddMessage("Start: release: 1.2")
    ...
    def recalculate_mileposts(self):
        ...
        for route in routes:
            ...
            where_clause = """"{}" = '{}'""".format(self._fields.route_name, route_with_direction)       
    ...
    def create_aliases(self, routes):
        ...
        for route in routes:
            ...
            where_clause = "{} = '{}'".format(self._fields.route_name, route)
